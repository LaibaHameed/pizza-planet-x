...
const About = () => {
    const array = [
        ["/team1.png", "John Carter", "Co-founder & Manager"],
        ["/team2.png", "Andy Smith", "Co-founder & Lead Chef"],
        ["/team3.png", "Sophie Moore", "Head of Staff"]
    ];

    return (
        <div className="min-h-screen bg-bg-white flex flex-col items-center">
            {/* Hero Section */}
            <section className="w-full bg-red-500 py-16 shadow-lg rounded-lg pb-20 text-center flex flex-col items-center">
                <h1 className="max-w-4xl 2xl:text-9xl xl:text-8xl sm:text-5xl text-4xl font-extrabold text-white mb-4 uppercase tracking-wider pb-12 pt-8">
            ...
            <section className="w-full flex flex-col items-center justify-center md:flex-row bg-slate-950 pt-32 px-6 md:px-12 shadow-lg rounded-lg">
                <div className="md:w-3/6 mb-6 md:mb-0 md:pr-4">
                    <Image
                ...
                <div className="md:w-3/6 md:pl-8">
                    <h2 className="text-5xl md:text-7xl font-bold mb-10">How our <br /> founders met</h2>
            ...
            <section className="w-full flex flex-col items-center justify-center md:flex-row bg-slate-950 py-28 px-6 md:px-12 shadow-lg rounded-lg mb-12">
                <div className="md:w-3/6 mb-6 md:mb-0 md:order-2 md:pl-4">
                    <Image
                ...
                <div className="md:w-3/6 md:order-1 md:pr-4">
                    <h2 className="text-5xl md:text-7xl font-bold mb-10">The story of our first Restaurant</h2>
                    <p className="text-slate-100 tracking-wide leading-relaxed mt-6">
            ...
            <section className="w-full text-center my-12">
                <h2 className="text-5xl md:text-7xl font-bold mb-10 text-slate-950">Meet our team</h2>
                ...
                <div className="flex flex-wrap justify-center my-10 gap-4">
                    {array.map((arr, index) => (
                        <div className="max-w-xs sm:max-w-sm mx-auto flex flex-col justify-center" key={index}>
                            ...
                            <h1 className="text-zinc-950 text-xl sm:text-2xl capitalize text-center mt-10 font-bold">{arr[1]}</h1>
                            <h1 className="text-red-600 text-lg sm:text-xl capitalize text-center mb-10 mt-5 font-bold">{arr[2]}</h1>
                        </div>
                    ))}
                </div>
            </section>
